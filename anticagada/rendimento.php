...
<?php
	...
	for($i=114; ; ){ //verifica novo período
		...
		if(!(($i==114)&&(strlen($str[114])!=6))){ //se não for isenção
			...
			echo"<div class='titulo' style='text-align:center;' onClick='MostrarEsconder($qtd_periodos)'><strong class='NumPeriodo' style='color:#6272b0; font-size:20px;'> $qtd_periodos º Período ($str[$i])</strong></div>";
			$Periodos[$qtd_periodos]->ano=$str[$i];

		}else{ //se for isenção
			$Periodos[$qtd_periodos]=new Periodo();
			echo"<div style='text-align:center;' onClick='MostrarEsconder($qtd_periodos)'><strong class='NumPeriodo' style='color:#6272b0; font-size:20px;'> Disciplinas isentas ($str[$i])</strong></div>";
			$Periodos[$qtd_periodos]->ano=$str[$i];
		}
		echo"<div id='tbody$qtd_periodos' style='display:block; margin:auto; text-align:left;' border='2px; solid black' cellpadding='2' cellspacing='2'>";
		...
		//		echo "<br>$tam | [$i] => $str[$i]";  //   29 | [120] => C�lculo I
			...
			echo "	<tr class='periodo$qtd_periodos' name='periodo$qtd_periodos'>
						...
						<td class='periodo$qtd_periodos' name='periodo$qtd_periodos' colspan='2' rowspan='1'><div style='width:400px; text-align:left; overflow:hidden;'>$info_disc[1]</div></td>
						...
						<td class='periodo$qtd_periodos' name='periodo$qtd_periodos'><div style='width:96px; text-align:center; overflow:hidden;'>$info_disc[6]</div></td>
					</tr>";			
			$i=$i+5;
		...
		//		echo"$soma_nota_total :: $cont_cred_total :: $cont_cred_isencao ::<br>";
				...
				echo"
					<tr class='periodo$qtd_periodos' name='periodo$qtd_periodos'>
						<td class='subtitulo' class='periodo$qtd_periodos' name='periodo$qtd_periodos'></td>
						<td class='subtitulo' class='periodo$qtd_periodos' name='periodo$qtd_periodos' style='text-align:right;'colspan='1'>Cr&eacute;d.Habilitados:</td>
						<td class='subtitulo' class='periodo$qtd_periodos' name='periodo$qtd_periodos' style='text-align:center;'>&nbsp;<span style='font-weight: bold;'>$info_per[0]</span></td>
						<td class='subtitulo' class='periodo$qtd_periodos' name='periodo$qtd_periodos' style='text-align:right;'colspan='2'>C.R.	no Per&iacute;odo:</td>
					...
					<tr class='periodo$qtd_periodos' name='periodo$qtd_periodos'>
						<td class='subtitulo' class='periodo$qtd_periodos' name='periodo$qtd_periodos'></td>
						<td class='subtitulo' class='periodo$qtd_periodos' name='periodo$qtd_periodos' style='text-align:right;'colspan='1'>Cr&eacute;d.Cursados:</td>
						<td class='subtitulo' class='periodo$qtd_periodos' name='periodo$qtd_periodos' style='text-align:center;'>&nbsp;<span style='font-weight: bold;'>$info_per[1]</span></td>
				...
				<tr style="list-style:none; margin:0px; width:100%;">
					<td>
						<div style="margin: 0px; width: 490px;">
							<table style="margin: 10px;">
								<tr><td> </td><?php for($i=1;($i<=$qtd_periodos);++$i) {echo"<td><b> &nbsp; &nbsp;$i º&nbsp; &nbsp;</b></td>";}?></tr>
								<tr><td>Aprovações</td><?php for($i=1;$i<=$qtd_periodos;++$i) {echo"<td style='text-align:center'><b>$aprovacao[$i]</b></td>";}?></tr>
								<tr><td>Reprovações</td><?php for($i=1;$i<=$qtd_periodos;++$i) {echo"<td style='text-align:center'><b>$reprovacao[$i]</b></td>";}?></tr>
							</table>
					...
					<td>
						<div style="margin: 0px; width: 490px;">
							<table style="margin: 10px;">
								<tr><td> </td><?php for($i=1;$i<=$qtd_periodos;++$i) {echo"<td><b> &nbsp; &nbsp;$i º&nbsp; &nbsp;</b></td>";}?></tr>
								<tr><td>CR/período</td><?php for($i=1;$i<=$qtd_periodos;++$i) {echo"<td style='text-align:center'><b>$cr_parcial[$i]</b></td>";}?></tr>
								<tr><td>CR</td><?php for($i=1;$i<=$qtd_periodos;++$i) {echo"<td style='text-align:center'><b>$cr_total[$i]</b></td>";}?></tr>
							</table>
