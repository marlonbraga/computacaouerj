...
<script>
	function professores(dep){
        ...
        function colorirNota($nota){
            ...
            $vermelho=0;
            $azul=0;
       /*          if(($nota>=0) && ($nota<2)){$vermelho=255; $verde=round($nota*85); $azul=0;}
            else if(($nota>=2) && ($nota<5)){$vermelho=round(255-($nota-3)*85); $verde=255; $azul=0;}
            else if(($nota>=5) && ($nota<8)){$vermelho=0; $verde=round(255-($nota-6)*85); $azul=round(($nota-6)*85);}
            else if(($nota>=8) && ($nota<=10)){$vermelho=0; $verde=0; $azul=255;}
            else {$vermelho=255; $verde=255; $azul=255;}
       */     
                 if(($nota>=0) && ($nota<3)){$vermelho=255; $verde=0; $azul=0;}
            else if(($nota>=3) && ($nota<6)){$vermelho=255; $verde=round(($nota-3)*255/3); $azul=0;}
            else if(($nota>=6) && ($nota<7.5)){$vermelho=round(255-(($nota-6)*255/1.5)); $verde=255; $azul=0;}
            else if(($nota>=7.5) && ($nota<9)){$vermelho=0; $verde=255; $azul=0;}
            else if(($nota>=9) && ($nota<=10)){$vermelho=0; $verde=0; $azul=255;}
            
            $nota="<font style='color: rgb($vermelho,$verde,$azul)'>$nota</font>";
            return $nota;
        }
        ?>